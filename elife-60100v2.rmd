...
list.of.packages <- c("sva", "RUVnormalize", "pheatmap", "edgeR", "GenomicFeatures", "mclust", "parallel", "ggplot2", "reshape2", "dplyr", "data.table", "DT", "RColorBrewer", "knitr", "ggrepel", "gridExtra", "grid", "plyr", "plotly", "Hmisc")
